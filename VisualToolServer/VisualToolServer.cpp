						...
						_In_ int       nCmdShow )
{
	...
	LoadString( hInstance, IDC_VISUALTOOLSERVER, szWindowClass, MAX_LOADSTRING );
	...
	hAccelTable = LoadAccelerators( hInstance, MAKEINTRESOURCE( IDC_VISUALTOOLSERVER ) );
...
ATOM MyRegisterClass( HINSTANCE hInstance )
{
	...
	wcex.hIcon = LoadIcon( hInstance, MAKEINTRESOURCE( IDI_VISUALTOOLSERVER ) );
	wcex.hCursor = LoadCursor( NULL, IDC_ARROW );
	wcex.hbrBackground = ( HBRUSH ) ( COLOR_WINDOW + 1 );
	wcex.lpszMenuName = MAKEINTRESOURCE( IDC_VISUALTOOLSERVER );
